...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'jiechen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Dreams in the Prime of Thirties', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.becase.top', // 网站地址
  ...
  FONT_URL: [
    'https://fonts.googleapis.com/css?family=Baloo+Bhaijaan|Inconsolata|Josefin+Sans|Montserrat|Roboto|Ubuntu|Varela+Round|Work+Sans',
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'the world is quiet here', // 站点描述，被notion中的页面描述覆盖
